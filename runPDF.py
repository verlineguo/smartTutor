...
def main(file, language, page):
    ...
    prompt_list: list[str] = [
        {"role": "system",
            "content": """
                Anda adalah seorang bot yang akan membantu dosen dalam merangkai 4 buah pertanyaan kritis dalam bahasa """ + language + """ untuk menguji pengetahuan mahasiswa.
                Pertama-tama terjemahkan dahulu dokumen atau teks yang diberikan ke bahasa """ + language + """. Pertanyaan-pertanyaan ini akan dirangkai berdasarkan narasi atau teks yang dimasukkan pengguna dan telah diterjemahkan sebanyak 4 pertanyaan. 
                Anda akan menggunakan template pertanyaan berdasarkan Taksonomi Bloom untuk menghasilkan pertanyaan yang sesuai dengan tingkat pemahaman yang diinginkan.
                ...
                UBAH FORMAT RESPONSE MENJADI BENTUK JSON yang dapat di DECODE !!! JANGAN RETURN SELAIN JSON !!!! BERIKUT MERUPAKAN CONTOHNYA dan jangan lupakan koma (,) untuk setiap akhir baris data question dan answer !!! :
